...
exports.cleanInfo = $util.cleanInfo = function(tree) {
    var r = [];
    tree = tree.slice(1);
...
exports.printTree = $util.printTree = function(tree) {
    require('sys').print($util.treeToString(tree));
};

exports.treeToString = $util.treeToString = function(tree, level) {
